...
namespace ByAeroBeHero.Controls
{
    ...
    /// </remarks>
    public partial class ProgressReporterDialogue2 : Form
    {
        private static readonly ILog log = LogManager.GetLogger(MethodBase.GetCurrentMethod().DeclaringType);

        private Exception workerException;
        public ProgressWorkerEventArgs2 doWorkArgs;
        ...
        public delegate void DoWorkEventHandler(object sender, ProgressWorkerEventArgs2 e, object passdata = null);

        // This is the event that will be raised on the BG thread
        public event DoWorkEventHandler DoWork;

        public ProgressReporterDialogue2()
        {
            InitializeComponent();
    ...
    public class ProgressWorkerEventArgs2 : EventArgs
    {
