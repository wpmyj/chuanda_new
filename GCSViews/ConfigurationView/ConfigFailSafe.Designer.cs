...
namespace ByAeroBeHero.GCSViews.ConfigurationView
{
    partial class ConfigFailSafe
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.groupBox4.Controls.Add(this.mavlinkCheckBoxgcs_fs);
            this.groupBox4.Controls.Add(this.mavlinkNumericUpDownFS_BATT_MAH);
            this.groupBox4.Controls.Add(this.label5);
            this.groupBox4.Controls.Add(this.mavlinkCheckBoxFS_GCS_ENABLE);
            this.groupBox4.Controls.Add(this.mavlinkCheckBoxthr_fs_action);
            this.groupBox4.Controls.Add(this.lbl_gpslock);
            this.groupBox4.Controls.Add(this.mavlinkCheckBoxthr_fs);
            this.groupBox4.Controls.Add(this.lbl_armed);
            this.groupBox4.Controls.Add(this.lbl_currentmode);
            ...
            this.groupBox4.Controls.Add(this.horizontalProgressBar9);
            this.groupBox4.Controls.Add(this.horizontalProgressBar4);
            this.groupBox4.Controls.Add(this.horizontalProgressBar10);
            this.groupBox4.Controls.Add(this.horizontalProgressBar5);
            this.groupBox4.Controls.Add(this.horizontalProgressBar11);
            this.groupBox4.Controls.Add(this.horizontalProgressBar6);
            this.groupBox4.Controls.Add(this.horizontalProgressBar12);
            this.groupBox4.Controls.Add(this.horizontalProgressBar7);
            this.groupBox4.Controls.Add(this.horizontalProgressBar13);
            this.groupBox4.Controls.Add(this.horizontalProgressBar8);
            this.groupBox4.Controls.Add(this.horizontalProgressBar14);
            this.groupBox4.Controls.Add(this.horizontalProgressBar16);
            this.groupBox4.Controls.Add(this.horizontalProgressBar15);
            ...
            this.panel2.Controls.Add(this.mavlinkComboFS_GCS_ENABLE);
            this.panel2.Controls.Add(this.label4);
            this.panel2.Controls.Add(this.lblFailSafeBegin);
            this.panel2.Controls.Add(this.cb_FS_Level_Enable);
            this.panel2.Controls.Add(this.lblPC);
            this.panel2.Controls.Add(this.lblLevel);
            this.panel2.Controls.Add(this.mavlinkNumericUpDownlow_voltage);
            this.panel2.Controls.Add(this.PNL_thr_fs_value);
            this.panel2.Controls.Add(this.mavlinkComboBoxfs_batt_enable);
            this.panel2.Controls.Add(this.mavlinkComboBox_fs_thr_enable);
        ...
        private System.Windows.Forms.Label pnlmah;
