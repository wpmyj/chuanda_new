...
namespace ByAeroBeHero.Utilities
{
   public class ParameterMetaDataRepositoryAutoTest
   {
      ...
      {
          string paramMetaDataXMLFileName = String.Format("{0}{1}{2}", Application.StartupPath, Path.DirectorySeparatorChar, "apm.pdef.xml");

          string paramMetaDataXMLFileNameBackup = String.Format("{0}{1}{2}", Application.StartupPath, Path.DirectorySeparatorChar, "apm.pdef.xml");
